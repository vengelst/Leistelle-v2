# Hikvision IP-Kamera Adapter

## Ziel

Der Hikvision-IP-Kamera-Adapter ist ein konkreter, kleiner Kamera-/Analytics-Integrationspfad ueber der bereits vorhandenen externen Alarm-Ingestion.
Er nimmt Hikvision-IP-Kamera-nahe Ereignisse an, normalisiert sie in `ExternalAlarmIngestionRequest` und delegiert danach an `POST /api/v1/alarm-ingestion/external`.
...
- `videomotion`, `motion`, `motiondetection`, `motion_detection` -> `motion`
- `linedetection`, `linedetectionstart`, `linedetectionstop`, `line_detection`, `line_detection_start` -> `line_crossing`
- `intrusion`, `intrusionstart`, `intrusionstop`, `fielddetection` -> `area_entry`
- `tamperdetection`, `shelteralarm` -> `sabotage`
- `videoloss`, `video_loss` -> `video_loss`
- `netbroken`, `networkdisconnected`, `ipconflict`, `ipaddressconflicted`, `ipcdisconnect` -> `camera_offline`
...
Hikvision-Kamera-Medien werden nur minimal referenziert:
...
- Duplikate laufen ueber dieselbe `externalSourceRef`-Idempotenz:
  `hikvision:camera:<sourceEventId>`
...
```json
{
  "sourceEventId": "HIK-CAM-499",
  "eventCode": "VideoMotion",
  "eventType": "motionDetection",
  "eventTime": "2026-04-10T18:20:00.000Z",
  ...
  "media": [
    {
      "mediaType": "snapshot",
      "url": "https://example.test/hikvision-camera-motion.jpg",
      "mimeType": "image/jpeg",
      "capturedAt": "2026-04-10T18:20:01.000Z"
    }
  ]
}
```
...
```json
{
  ...
  "eventTime": "2026-04-10T18:20:00.000Z",
  "severity": "high",
  "title": "Hikvision Camera Yard Kamera 1 | Motion",
  "description": "Analytics Motion Detection | Regel Bewegung Nord | Zone yard-north",
  "zone": "yard-north",
  "cameraName": "Yard Kamera 1",
  "media": [
    {
      "storageKey": "https://example.test/hikvision-camera-motion.jpg",
      "mediaKind": "snapshot",
      "mimeType": "image/jpeg",
      "capturedAt": "2026-04-10T18:20:01.000Z"
    }
...
```json
{
  ...
  "eventTime": "2026-04-10T18:30:00.000Z",
  "severity": "high",
  "title": "Hikvision Camera Yard Kamera 1 | Line Crossing",
  "description": "Analytics Line Detection | Regel Nordtor Linie | Zone yard-entry",
  "zone": "yard-entry",
  "cameraName": "Yard Kamera 1",
  "media": [
    {
      "storageKey": "https://example.test/hikvision-camera-snapshot.jpg",
      "mediaKind": "snapshot",
      "mimeType": "image/jpeg",
      "capturedAt": "2026-04-10T18:30:01.000Z"
    }
...
```json
{
  ...
  "eventTime": "2026-04-10T18:40:00.000Z",
  "severity": "critical",
  "title": "Hikvision Camera Yard Kamera 1 | Video Loss",
  "description": "Videostream der Kamera ist abgerissen",
  "cameraName": "Yard Kamera 1",
  "media": [
    {
      "storageKey": "https://example.test/hikvision-camera-clip.mp4",
      "mediaKind": "clip",
      "mimeType": "video/mp4"
    }
  ]
...
- keine vollstaendige Hikvision-Kameraplattformintegration
- keine vollstaendige ISAPI-/ONVIF-/FTP-/E-Mail-/RTSP-Abdeckung
...
Spaetere reale Hikvision-Kamera-Collector oder kameranahe Integrationen koennen denselben Pfad nutzen:

1. kamera-nahe Payloads in dieses kleine Schema uebersetzen
2. an `POST /api/v1/alarm-ingestion/external/hikvision/ip-camera` oder direkt an denselben Adapter-Service uebergeben
